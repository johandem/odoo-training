...
class TaskType(models.Model):
    ...
    def _compute_label(self):
        for r in self:
            if r.description:
                r.label = "%s - %s" % (r.name, r.description)
            else:
                r.label = r.name
    ...
    def _name_search(self, name='', args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        return super(TaskType, self)._name_search(name='', args=args, operator='ilike', limit=limit, name_get_uid=name_get_uid)
